...
type ControlIconKind = "search" | "show" | "sort";
...
function PendingStatusIcon() {
  return <span className="client-file-status-icon client-file-status-pending" role="img" aria-label="Validation not available" title="Validation not available">·</span>;
}
