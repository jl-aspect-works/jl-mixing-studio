...
export function ProjectRouteContent(p: ProjectRouteContentProps) {
  ...
  if (p.view === "audioPrep") return <AudioPrepView client={p.client} project={p.project} reportState={p.intakeReport} onValidationRefresh={p.onStructuredValidationRefresh} {...common} />;
  if (p.view === "references") return <ReferencesView client={p.client} project={p.project} {...common} />;
